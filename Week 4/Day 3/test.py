...
class TestExtend(unittest.TestCase):
    ...
    def test_add_negative_plus_positive(self):
        self.assertEqual(extend.add(4, -11), -7)
    ...
    def test_median_zero(self):
        self.assertFalse(extend.median([]), False)
    ...
    def test_translate_similar_vowel(self):
        self.assertEqual(extend.translate('lehel'), 'levehevel')
